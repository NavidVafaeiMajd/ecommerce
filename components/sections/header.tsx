...
export const Header = () => {
    return ( 
        <div className="fixed top-0 left-0 w-full h-[108px] bg-[background]! z-10!">
            <div className="container m-auto! flex items-center justify-between! h-full px-5" >
                ...
                <div>
                    <HeaderNav items={[{name : "Home" , link : "/"} , {name : "Shop" , link : "/shop"} , {name : "Man" , link : "/man"} , {name : "Woman" , link : "/woman"}]}/>
                </div>
                <div>
